...
public class Lexer {
    ...
    private void scanToken() {
        ...
        switch (c) {
            case '[': addToken(ARRAY_OPEN); break;
            case ']': addToken(ARRAY_CLOSE); break;
            ...
            default:
                if (isDigit(c)) {
                    ...
                    JavaLoXRuntime.error(line, "Unexpected character.");
                }
        }
    }
    ...
    private void scanChar() {
        ...
        pointToNextChar();
        if (getCurrentChar() != '\'') {
            JavaLoXRuntime.error(line, "Unterminated char variable.");
            return;
        }
        pointToNextChar();
